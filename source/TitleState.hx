	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					addMoreText('T5mpler', 15);
					addMoreText('1up', 15);
					addMoreText('RhythmShadow', 15);
				case 3:
					deleteCoolText();
				case 5:
					createCoolText(['Made in Psych Engine'], 15);
				case 7:
					addMoreText('which is made by', 15);
				case 9:
					deleteCoolText();
				case 11:
					createCoolText(['ShadowMario', 'RiverOaken', 'shubs'], 15);
				case 13:
					addMoreText('and more!', 15);
				case 15:
					deleteCoolText();
				case 16:
					createCoolText(['Mod based off of:'], 15);
				case 18:
					addMoreText('Bambi Civilization', 15);
					addMoreText('Lol', 15);
					ngSpr.visible = true;
				case 20:
					deleteCoolText();
				...
				case 26:
					deleteCoolText();
				case 28:
					createCoolText(['Vs.'], 15);
				case 30:
					addMoreText('Rambi', 15);
				case 32:
					skipIntro();
			}
		}
