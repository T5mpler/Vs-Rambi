...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var check_rambiSection:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		check_rambiSection = new FlxUICheckBox(130, 100, null, null, "Rambi Section", 100);
		check_rambiSection.name = 'check_rambi';
		check_rambiSection.checked = _song.notes[curSection].rambiSection;
		...
		tab_group_section.add(check_rambiSection);
		...
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				case 'Must hit section':
					...
					updateHeads();
				case 'Rambi Section':
					_song.notes[curSection].rambiSection = check.checked;
	...
	function updateSectionUI():Void
	{
		...
		check_rambiSection.checked = sec.rambiSection;
	...
	function updateHeads():Void
	{
		...
		if (_song.notes[curSection].mustHitSection)
		{
			...
			if (_song.notes[curSection].rambiSection) leftIcon.changeIcon('rambi');
		}
		else
		{
			...
			if (_song.notes[curSection].gfSection) leftIcon.changeIcon('gf');
			if (_song.notes[curSection].gfSection) leftIcon.changeIcon('rambi');
